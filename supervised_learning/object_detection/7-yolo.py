...
class Yolo:
    ...
    def predict(self, folder_path):
        ...
        boxes, box_confidences, box_class_probs = self.process_outputs(outputs,
                                                                       image_shapes)
        filtered_boxes, box_classes, box_scores = self.filter_boxes(boxes,
                                                                    box_confidences,
                                                                    box_class_probs)
        boxes, box_classes, box_scores = self.non_max_suppression(filtered_boxes,
                                                                   box_classes,
                                                                   box_scores)
        return (boxes, box_classes, box_scores, image_paths)
